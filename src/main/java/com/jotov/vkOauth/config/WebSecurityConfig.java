...
//        return filter;
    ...
    public ResourceServerProperties vkResource() { return new ResourceServerProperties(); }

    @Bean
    @ConfigurationProperties("vk.client")
    public OAuth2ProtectedResourceDetails vk() { return new AuthorizationCodeResourceDetails(); }
